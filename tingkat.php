...
<div class="container">
  <section class="content-header">
    <h1><i class="fa fa-list-ol"></i> Tingkat</h1>
  </section>
  <?php 
  if($act == 'add'){
  	?>
  <section class="content">
    <div class="box box-default">
      ...
      <div class="box-body">
		<form method="POST" action="insert-tingkat.php" enctype="multipart/form-data">
			<input type="hidden" name="table" value="<?php echo $table;?>">
			<input type="hidden" name="option" value="<?php echo $option;?>">
			<div class="form-group">
              <label for="tingkat">Tingkat *</label>
              <input type="text" class="form-control" id="tingkat" required name="tingkat" placeholder="Masukkan Tingkat">
            </div>
  ...
  <section class="content">
    <div class="box box-default">
      ...
      <div class="box-body">
		<form method="POST" action="update-tingkat.php" enctype="multipart/form-data">
			<input type="hidden" name="table" value="<?php echo $table;?>">
			<input type="hidden" name="option" value="<?php echo $option;?>">
			<input type="hidden" name="id" value="<?php echo $id;?>">
			<div class="form-group">
              <label for="tingkat">Tingkat *</label>
              <input type="text" class="form-control" id="tingkat" required name="tingkat" placeholder="Masukkan Tingkat" value="<?php echo $row['tingkat'];?>">
            </div>
            <button type="submit" class="btn btn-primary">Simpan</button>&nbsp;&nbsp;&nbsp;
            <button type="button" onclick="actBatal();" class="btn btn-danger">Batal</button>
		</form>
      ...
      <div class="box-body">
	      	...
	      	<form method="post" class="form-horizontal" action="index.php?option=<?php echo $option;?>">
				...
				<div class="col-sm-5">
					<div class="input-group input-group-md">
						<input type="text" name="key" value="<?php echo $key;?>" class="form-control" placeholder="Masukkan Tingkat">
		...
		<div class="table-responsive">
			<table class="table table-bordered">
				...
				<tr>
					<td><?php echo $no;?></td>
					<td><?php echo Highlight($row['tingkat'], $key);?></td>
